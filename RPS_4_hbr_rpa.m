...
%% Scan for all subjects
  sourceList    = dir([srcPath, 'RPS_*_hbr_*.mat']);
  ...
  for i=numOfPart
    ...
    filename    = sprintf(['RPS_%02d_C_hbr_p%04d'], i, rpa_id);
...
%% Scan for all subjects
  ...
  for i=numOfPart
    ...
    filename    = sprintf(['RPS_%02d_FP_hbr_p%04d'], i, rpa_id);
...
%% Scan for all subjects
  ...
  for i=numOfPart
    ...
    filename    = sprintf(['RPS_%02d_PD_hbr_p%04d'], i, rpa_id);
...
%% Scan for all subjects
  ...
  for i=numOfPart
    ...
    filename    = sprintf(['RPS_%02d_PS_hbr_p%04d'], i, rpa_id);
