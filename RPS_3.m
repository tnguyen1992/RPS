...
pnoi = zeros(2,1);
  ...
  sigPart1 = [data_sub1.t, hboSub1(:,1)];
  sigPart2 = [data_sub2.t, hboSub2(:,1)];
...
for i=1:1:numOfChan
  if ~isnan(hboSub1(1, i)) && ~isnan(hboSub2(1, i))                         % check if this channel was not rejected in both subjects during preprocessing
    sigPart1 = [data_sub1.t, hboSub1(:,i)];
    sigPart2 = [data_sub2.t, hboSub2(:,i)];
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_C'], id), ...
                     '.mat');
