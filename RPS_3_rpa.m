...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_C_p%04d'], id, n), ...
                     '.mat');
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_FP_p%04d'], id, n), ...
                     '.mat');
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_PD_p%04d'], id, n), ...
                     '.mat');
...
for id = [21 22 23 24 25 26 28 29 30 31 32]
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_PS_p%04d'], id, n), ...
                     '.mat');
