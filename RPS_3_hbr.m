...
desPath = 'P:\projects\RPS\RPS\procData\wtcData\Data_C\';                  % processed data location
...
for id = numOfPart
  ...
  filename_sub2    = sprintf(['RPS_%02d_sub2_C'], id);
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_C_hbr'], id), ...
                     '.mat');
...
desPath = 'P:\projects\RPS\RPS\procData\wtcData\Data_FP\';                  % processed data location
%% Scan for all subjects
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_FP_hbr'], id), ...
                     '.mat');
...
desPath = 'P:\projects\RPS\RPS\procData\wtcData\Data_PD\';                  % processed data location
%% Scan for all subjects
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_PD_hbr'], id), ...
                     '.mat');
...
desPath = 'P:\projects\RPS\RPS\procData\wtcData\Data_PS\';                  % processed data location
%% Scan for all subjects
...
% save preprocessed data
  ...
  file_path = strcat(desFolder, sprintf(['RPS_%02d_PS_hbr'], id), ...
                     '.mat');
